...
function Dashboard() {
  ...
  return (
    <>
      <SideMenu />
      <div className=" sm:pl-[30px] lg:pl-[23rem] h-[310vh] bg-white  w-[100%]">
        ...
        <div className=" mt-[44px] sm:grid lg:flex justify-between  w-[98%]  items-center ">
          {/* Box 1 */}
          <Link className=" text-[18px] text-[#808285] font-normal   " to="">
            <div className=" border-[#AFAFAF]  flex justify-between pr-[32px] pl-[32px] items-center border-[0.5px] w-[420px] rounded-[12px] opacity-[1] h-[138px] ">
              <div>
