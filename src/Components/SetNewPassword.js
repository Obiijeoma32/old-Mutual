...
function SetNewPassword() {
  ...
  return (
    <>
      <div className=" pt-[70px] justify-center flex items-center ">
        <div>
          ...
          <div className=" w-[504px] z-[2] relative  pt-[37px] pl-[32px] h-[556px] bg-white rounded-[16px] ">
            <div>
              ...
              <input className=" outline-none font-medium w-[440px] h-[52px] border-[0.5px] mt-[52px] text-[16px] text-[#9C9898]  pl-[24px] rounded-[4px] opacity-[1] border-[#9C9898] " type="password" placeholder="Retype Password" />
      ...
      {/* Modal */}
      {isOpen && (
        <div onClick={() => setIsOpen(false)} className=" top-0 left-0 z-[2] flex justify-center items-center bg-[#767171] fixed bg-opacity-[54%] w-[100%] h-[100vh]  ">
          <div className="w-[800px] h-[418px] rounded-[8px]  bg-white opacity-[1]  ">
            <div className=" pt-[51.41px] flex-col flex items-center justify-center">
              ...
              <h3 className=" tracking-[0.14px] mt-[28px] font-medium text-[24px] text-[#1A1A1A] ">Reset Password Successful!</h3>
              <p className="text-[16px] mt-[20px] tracking-[0.19px] text-[#222222] font-normal ">Your password has been updated, click the button below to login.</p>
              <Link onClick={() => window.scroll(0, 0)} to="/login">
                <button className="w-[225px] h-[44px] text-[#fff] text-[16px] tracking-[0.26px] font-[600] mt-[44px] bg-[#50B848] opacity-[1] rounded-[4px] ">Login</button>
              </Link>
            </div>
          </div>
        </div>
