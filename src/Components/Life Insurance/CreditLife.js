 ...
 ${
   creditIndividual
     ...
     : "text-[16px] hover:text-[#2778C3] cursor-pointer font-normal opacity-[1] tracking-[0.26px]  text-[#808285]"
      ...
      {/* Dropdown menu bar */}
      {isOpen && (
        <div className=" w-[190px] phone:left-[22rem] sm:left-[27rem] absolute pl-[15px] pb-[15px] pt-[15px] pr-[15px] lg:left-[66rem] top-[4.5rem] h-[230px] bg-white border-[0.5px] border-[#AFAFAF] rounded-[2px] opacity-1 ">
