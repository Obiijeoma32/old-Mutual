...
import ToggleSwitch from "../ToggleButton/Index";
...
function MotorClaim() {
  ...
  const claimType = [
    { value: "Partial Loss", label: "Partial Loss" },
    { value: "Total Loss", label: "Total Loss" },
    { value: "Total Theft", label: "Total Theft" },
  ...
  return (
    <>
      <SideMenu />
      {/* LARGE SCREENS */}
      <div className=" mobile:hidden lg:block pl-[22rem] h-fit pb-[50px]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard / Claims /<span className="text-[20px] text-[#009677] tracking-[0.32px] "> Motor Claims</span>
          </h3>
        </div>
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Motor Claims</h3>
            <p className="text-[18px] font-normal mt-[8px] text-[#1A1A1A] ">Fill in Claims Information</p>
          </div>
        </div>
        {/* Claims Information Container */}
        <div className="w-[95%] mt-[28px]">
          ...
          <div className=" w-full  p-[30px] bg-white h-fit ">
            <form className=" flex flex-wrap gap-[30px] items-center ">
              <section className="">
                <label className="text-[#808080] mb-[10px] " htmlFor="">
                  Claim Type
                </label>
                <SelectInput label={claimType} placeholder={""} />
              </section>
              <section className="">
              ...
              <section className="">
                <label className="text-[#808080] " htmlFor="">
                  Photograph of Vehicle Damage(1)
                </label>
                <div className="w-[350px] border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]">
                  <div className="bg-[#F6F7F9] border-r-[#9C9898] flex justify-center items-center rounded-l h-[49px] border-r-[0.5px] w-[70px] ">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <section className="">
                <label className="text-[#808080] " htmlFor="">
                  Photograph of Vehicle Damage(2)
                </label>
                <div className="w-[350px] border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]">
                  <div className="bg-[#F6F7F9] border-r-[#9C9898] flex justify-center items-center rounded-l h-[49px] border-r-[0.5px] w-[70px] ">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-[95%]">
          ...
          <div className=" w-full  p-[30px] bg-white ">
            <div className="flex max-w-[60%] flex-wrap mt-6 items-center justify-between">
              <section className="">
                <label className="text-[#808080] " htmlFor="">
      ...
      <div className=" mobile:flex h-fit pb-[50px] lg:hidden flex w-full justify-center items-center ">
        <div className="w-[85%] flex flex-col justify-between   ">
          ...
          <div className=" mt-[40px]">
            <div className="text-left">
              <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Motor Claims</h3>
              <p className="text-[14px] font-normal mt-[8px] text-[#1A1A1A] ">Fill in Claims Information</p>
            </div>
          </div>
          {/* Claims Information Container */}
          <div className="w-[95%] mt-[28px]">
