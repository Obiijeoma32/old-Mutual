      ...
      <div className=" sm:pl-[30px] lg:pl-[23rem] h-[180vh]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard / Claims /<span className="text-[20px] text-[#009677] tracking-[0.32px] "> Fire Claims</span>
          </h3>
        </div>
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Fire Claims</h3>
          ...
          <div className=" w-full p-[30px] bg-white h-fit ">
            <form className=" ">
              <div className="flex  mt-6 items-center justify-between">
                ...
                <section className="">
                  <label className="text-[#808080] " htmlFor="">
                    Repairs Estimate (NGN)
                  </label>
                  <input type="text" className="w-[350px] pl-3 border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]" />
                </section>
              </div>
              <div className="flex mt-6 items-center justify-between">
                ...
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pb-[10px] bg-[#E9ECEF] pt-[10px] rounded w-[350px] flex flex-col justify-between h-[52px] ">
                  <label htmlFor="">Sum Insured (NGN)</label>
