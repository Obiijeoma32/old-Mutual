...
function MarineClaim() {
  ...
  const claimType = [
    { value: "Cargo/Aviation", label: "Cargo/Aviation" },
  ...
  return (
    <>
      <SideMenu />
      <div className=" sm:pl-[30px] lg:pl-[23rem] h-[150vh]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard / Claims /<span className="text-[20px] text-[#009677] tracking-[0.32px] "> Marine Claims</span>
          </h3>
        </div>
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Marine Claims</h3>
          ...
          <div className=" w-full p-[30px] bg-white h-fit ">
            <form className=" ">
              ...
              <div className="flex mt-6 items-center justify-between">
                ...
                <section className="">
                  <label className="text-[#808080] " htmlFor="">
                    Marine certificate (Cert of Seaworthiness)
                  </label>
                  <div className="w-[350px] border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]">
                    <div className="bg-[#F6F7F9] border-r-[#9C9898] flex justify-center items-center rounded-l h-[49px] border-r-[0.5px] w-[70px] ">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
