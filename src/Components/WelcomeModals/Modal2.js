function Modal2({ handleCloseModal1, handleOpenModal, handleOpenModal2, setModalOpen2 }) {
  return (
    <>
      <div onClick={() => setModalOpen2(false)} className=" top-0 left-0 z-[2] flex justify-center items-center bg-[#767171] fixed bg-opacity-[54%] w-[100%] h-[100vh]  ">
        <div className="w-[800px] h-[450px] rounded-[8px] p-[27px]  bg-white opacity-[1]  ">
