...
function FireandSpecialPerils() {
  ...
  return (
    <>
      <SideMenu />
      {/* LARGE SCREENS */}
      <div className=" pl-[22.5rem] h-fit pb-[50px] mobile:hidden lg:block   w-[100%]">
                ...
                <tbody className=" text-[16px] font-normal  text-[#575757] bg-[#FAFAFA] w-full h-[355px]  ">
                  <tr className="  ">
                    <td className="w-[30%] pt-[20px] border-r-[1px] pr-[15px] pl-[15px]  border-r-[#E4E7ED] ">
                      This policy indemnifies the insured against any material damage, loss, or destruction to the property due to a fire disaster or any other insured peril. <br />
                      <span className="text-[#1A987B]">Property covered include Buildings , Contents – furniture, household, and office , Stock-in-trade , Plant and machinery, Rent loss. </span>
                    </td>
                    <td className="border-r-[1px] px-[10px]  border-r-[#E4E7ED]">NGN100,000 - NGN900,000,000 </td>
            ...
            <div className="w-[98%] h-fit rounded-[8px] mt-[50px] bg-[#F1F2F2] ">
              <table className="  w-[100%] h-fit border-[1px] rounded-[8px] border-[#E4E7ED] justify-between items-center ">
                ...
                <tbody className=" text-[16px] font-normal  text-[#575757] bg-[#FAFAFA] w-full h-[355px]  ">
                  <tr className="   ">
                    <td className="w-[30%] pt-[20px] border-r-[1px] pr-[15px] pl-[15px]  border-r-[#E4E7ED] ">
                      This product protects against the loss of or damage to the insured's property whether it is owned, held in trust, or for which he is responsible for.
                      <br />
                      <span className="text-[#1A987B]">
                        The scope of cover includes:
                        <ul className=" pl-[15px] list-disc ">
                          <li>Furniture and other property (owned by the insured) on the premises.</li>
                          <li>Household contents including those for which the insured is responsible, if specifically covered.</li>
                          <li>Damage to premises resulting from burglary or attempted burglary and/or housebreaking.Cash, jewelry, and valuables if specifically covered.</li>
                        </ul>
                      </span>
                    </td>
      ...
      <div className=" mobile:flex h-fit pb-[50px] lg:hidden flex w-full justify-center items-center ">
        <div className="w-[85%] flex flex-col justify-between   ">
          ...
          <div className="mt-[40px]">
            <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
              Dashboard /<span className="text-[18px] text-[#009677] tracking-[0.32px] "> Fire & Special Perils</span>
            </h3>
          </div>
          <div className=" mt-[40px]">
            <div className="text-left">
              <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Fire & Special Perils</h3>
              <p className="text-[14px] font-normal mt-[8px] text-[#1A1A1A] ">Get Quotes for Fire, Burglary</p>
            </div>
          </div>
          <div className=" w-[98%] h-fit pb-[50px] pl-[25px] pt-[37px] rounded-[8px] mt-[44px] bg-white ">
            {/* Fire & Special Perils Container */}
            <div className="w-[98%]  border-b-[#DFDEDE]  border-b-[2px] rounded-[8] ">
              <div className=" w-[180px] flex justify-between items-center  ">
                <h3
 ...
 ${
   fire
     ...
     : "text-[16px] hover:text-[#2778C3] cursor-pointer font-normal opacity-[1] tracking-[0.26px]  text-[#808285]"
            ...
            {burglary && (
              <div className="w-[98%] h-fit overflow-x-scroll rounded-[8px] mt-[50px] bg-[#F1F2F2] ">
                <table className="  w-[100%] h-fit border-[1px] rounded-[8px] border-[#E4E7ED] justify-between items-center ">
                  <thead className=" border-b-[1px] pb-[10px] border-b-[#E4E7ED]">
                    <tr className="text-[18px] text-left font-[400px] text-[#575757] tracking-[0.36px] ">
                      <th className=" w-[50%] pt-[30px] pl-[15px] border-r-[1px] pb-[10px] border-r-[#E4E7ED]   ">About This Plan</th>
...
export default FireandSpecialPerils;
