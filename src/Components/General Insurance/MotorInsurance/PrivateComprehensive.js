          ...
          <tbody className=" text-[16px] font-normal  text-[#575757] bg-[#FAFAFA] w-full h-[355px]  ">
            <tr className="  ">
              <td className="w-[30%] pt-[20px] border-r-[1px] pr-[15px] pl-[15px]  border-r-[#E4E7ED] ">
                On this comprehensive policy, you will be covered for any accidental damage to your vehicle and any loss by theft and fire. We've also got you covered for third party property damage. You can choose any of the following three options
                on Comprehensive Motor Insurance: Auto Diamond, Auto Gold and Auto Silver. <br />
                <span className="text-[#1A987B]">Vehicle damages up to NGN 5,000,000 Compensation for bodily harm or death is unlimited, but can be capped at reasonable amount. </span>
              </td>
              <td className="border-r-[1px] pl-[10px]  border-r-[#E4E7ED]">% of SumInsured </td>
              <td className="border-r-[1px] pl-[10px]  border-r-[#E4E7ED]">2% - 2.5% </td>
...
export default PrivateComprehensive;
