          ...
          <tbody className=" text-[16px] font-normal  text-[#575757] bg-[#FAFAFA] w-full h-[355px]  ">
            <tr className="  ">
              <td className="w-[30%] pt-[20px] border-r-[1px] pr-[15px] pl-[15px]  border-r-[#E4E7ED] ">
                The Third-Party Motor policy covers death or bodily injuries and damages to the property of a third party caused by the use of the insured car. <br />
                <span className="text-[#1A987B]">Property damages up to NGN 1,000,000 Compensation for bodily harm or death is unlimited, but can be capped at reasonable amount. </span>
              </td>
...
export default CommercialThirdParty;
