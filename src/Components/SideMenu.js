...
function SideMenu({ children }) {
  ...
  return (
    <>
      <div className="opacity-[1] mobile:hidden sm:hidden md:hidden lg:block  fixed top-0 shadow-lg left-0 pt-[32px] bg-white rounded-r-[24px] drop-shadow-[24px] shadow-[#0000003D] w-[328px] h-[200vh] ">
        <div className=" overflow-x-scroll h-[100vh] ">
          <div className=" w-[210px] ml-[59px] mb-[32px] h-[47px] ">
            <img src={logo} alt="old mutual" />
          </div>
          {/* User Persona */}
          <div className="h-[130px] flex flex-col justify-center items-center  pb-[14px] w-[100%] bg-[#f1f2f2] ">
            <Link to="/brokerprofile">
              <svg className="transition-transform transform hover:scale-110 " width="43.91" height="43.91" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div className="flex justify-between items-center mt-[27px] w-[55%]">
              <h3 className="text-[16px] font-medium opacity-[1]  tracking-[0.32px] text-left text-[#808285] ">OFILI VALENTINE</h3>
              <Link to="/login">
                <svg width="19.12" height="19.12" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className=" w-[90%] text-left flex flex-col justify-between items-center mt-[36.88px] ">
            <Link onClick={handleIsActive} className={isActive ? "text-[#009677] w-[75%]" : "text-[#58595B] w-[75%"} to="/dashboard">
              <div className=" opacity-[1]    flex  items-center  ">
                ...
                <h3 className="text-[16px]  font-medium  ">Dashboard</h3>
              </div>
            </Link>
          </div>
          {/* LIFE INSURANCE CONTAINER*/}
          <div className=" flex flex-col w-[90%]  mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggle(!toggle)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              LIFE INSURANCE
            </h2>
            {toggle && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
                {lifeInsurance.map((item, id) => (
                  <NavLink onClick={() => handleLifeActive(id)} key={id} className=" mb-[20px] hover:text-[#2778C3]  opacity-[1] text-[#58595B] flex justify-between items-center w-[100%]  " to={item.path}>
                    <div style={{ color: id === lifeActive ? "#2778C3" : "#58595B" }} className=" justify-between w-[120px] flex items-center ">
                      <span>{item.icon}</span>
                      <h3 className="text-[16px] tracking-[0.32px] font-medium  ">{item.name}</h3>
                    </div>
                    <div>{item.arrow}</div>
                  </NavLink>
                ))}
          ...
          <div className=" flex flex-col w-[90%]   mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggleGeneral(!toggleGeneral)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              GENERAL INSURANCE
            </h2>
            {toggleGeneral && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
          ...
          <div className=" flex flex-col w-[90%]   mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggleClaims(!toggleClaims)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              CLAIMS PROCESSING
            </h2>
            {toggleClaims && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
          ...
          <div className=" flex flex-col w-[90%]   mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggleLifeClaim(!toggleLifeClaim)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              LIFE CLAIMS
            </h2>
            {toggleLifeClaim && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
          ...
          <div className=" flex flex-col w-[90%]    mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggleClientManagement(!toggleClientManagement)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              CLIENT MANAGEMENT
            </h2>
          ...
          <div className=" flex flex-col w-[90%]    mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setTogglePayment(!togglePayment)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              PAYMENTS
            </h2>
            {togglePayment && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
          ...
          {/* REPORTS CONTAINER */}
          <div className=" flex flex-col w-[90%] pb-[200px]   mt-[28.12px]  justify-between items-center opacity-[1]">
            <h2 onClick={() => setToggleReports(!toggleReports)} className=" opacity-[1] cursor-pointer w-[75%] text-[16px] text-left tracking-[0.26px] font-medium  text-[#808285]  ">
              REPORTS
            </h2>
            {toggleReports && (
              <div className=" mt-[20px] pl-[20px] w-[90%] ">
