            ...
            <form className=" ">
              ...
              <div className="mt-3">
                <p className="text-[14px]">
                  Claims Form{" "}
                  <a href="/form.pdf" download="form.pdf" className=" cursor-pointer text-[#009677] tracking-[0.32px] ">
                    {" "}
                    Download Here |
                  </a>
                  <a href="/form.pdf" className=" text-[#009677] tracking-[0.32px] ">
                    {" "}
                    Fill Claim Form
                  </a>
                </p>
