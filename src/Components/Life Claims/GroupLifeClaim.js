...
function GroupLifeClaims() {
  ...
  return (
    <>
      <SideMenu />
      <div className=" sm:pl-[30px] lg:pl-[23rem] h-[180vh]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard / Claims /<span className="text-[20px] text-[#009677] tracking-[0.32px] "> Group Personal Claims</span>
          </h3>
        </div>
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Group Personal Claims</h3>
            <p className="text-[18px] font-normal mt-[8px] text-[#1A1A1A] ">Fill in Claims Information</p>
          </div>
        </div>
            ...
            <form className=" ">
              ...
              <div className="mt-3">
                <p className="text-[14px]">
                  Claims Form <span className=" text-[#009677] tracking-[0.32px] "> Download Here |</span>
                  <span className=" text-[#009677] tracking-[0.32px] "> Fill Claim Form</span>
                </p>
              </div>
              <div className="flex mt-6 items-center justify-between">
                ...
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pb-[10px] pt-[10px] rounded w-[350px] flex flex-col justify-between h-[52px] ">
                  <label htmlFor="">Claim Amount (NGN)</label>
                  <input className=" outline-none w-full h-2/4 bg-none" type="text" />
                </div>
              </div>
              <div className="flex mt-6  items-center justify-between">
                <div className=" px-3 border-solid border-[0.5px] bg-[#E9ECEF] border-[#9C9898] text-[#cccccc] pb-[10px] pt-[10px] rounded w-[350px] flex flex-col justify-between h-[52px] ">
                  <label htmlFor="">Policy Holder</label>
                  <input className=" bg-transparent outline-none w-full h-2/4 bg-none" type="text" />
                </div>
                <div className=" px-3 border-solid bg-[#E9ECEF] border-[0.5px] border-[#9C9898] text-[#cccccc] pb-[10px] pt-[10px] rounded w-[350px] flex flex-col justify-between h-[52px] ">
              ...
              <div className="mt-6">
                ...
                <div className="w-[70%]  border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]">
                  <div className="bg-[#F6F7F9]  border-r-[#9C9898] flex justify-center items-center rounded-l h-[49px] border-r-[0.5px] w-[70px] ">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_16_204)">
                        <path
              ...
              <div className=" mt-6 px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pb-[10px] pt-[10px] rounded w-[350px] flex flex-col justify-between h-[52px] ">
...
export default GroupLifeClaims;
